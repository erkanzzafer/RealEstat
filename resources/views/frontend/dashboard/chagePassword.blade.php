 ...
 <form action="{{route('user.password.update')}}" method="post" class="default-form">
    @csrf
        <div class="form-group">
            ...
            <input type="password" name="old_password" id="old_password" @error('old_password') is-invalid @enderror>
            @error('old_password')
        ...
        <div class="form-group">
            ...
            <input type="password" name="new_password" id="new_password" @error('new_password') is-invalid @enderror>
            @error('new_password')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
