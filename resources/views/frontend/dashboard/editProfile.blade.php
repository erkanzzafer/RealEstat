...
<section class="sidebar-page-container blog-details sec-pad-2">
       ...
       <img src="{{ asset('upload/user_images/'.($userData->photo ?? 'no_image.jpg')) }}" alt=""></a></figure>
 ...
 <form  enctype="multipart/form-data" action="{{route('user.profile.store')}}" method="post" class="default-form">
    @csrf
  ...
  <div class="form-group">
              <img id="showImage" src="{{ asset('upload/user_images/'.($userData->photo ?? 'no_image.jpg')) }}" style="width: 100px; height: 100px;" alt="">
        </div>
