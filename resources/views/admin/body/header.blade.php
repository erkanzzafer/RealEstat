<nav class="navbar">
            ...
            @endphp
                ...
                src="{{ asset('upload/admin_images/' . ($data->photo ?? 'no_image.jpg')) }}" alt="profile">
							</a>
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									<div class="mb-3">
										<img class="wd-80 ht-80 rounded-circle" src="{{ asset('upload/admin_images/' . ($data->photo ?? 'no_image.jpg')) }}" alt="">
									</div>
